...
public class Dray : MonoBehaviour,IFacingMover
{
    ...
    private KeyCode[] keys = new KeyCode[]{ KeyCode.RightArrow, KeyCode.UpArrow,
     KeyCode.LeftArrow, KeyCode.DownArrow,KeyCode.D,KeyCode.W,KeyCode.A,KeyCode.S
    };
    void Awake()
    {
        IFM = this;
    ...
    void Update()
    {
        ...
        {
            case eMode.attack:
                anim.Play("Dray_Attack_" + facing); // Play attack animation
                anim.speed = 0;
                break;
            case eMode.idle:
                anim.Play("Dray_Walk_" + facing); // Play idle animation
                anim.speed = 0;
                break;
            case eMode.move:
                vel = directions[dirHeld];
                anim.Play("Dray_Walk_" + facing); // Play walk animation
                anim.speed = 1;
                break;
        }
